...
export class MeetTheHerdComponent {
  ...
  herd = [
    ...
    },
    {
      ...
      name: 'Mistee',
      bio: 'Mistee was donated to HELP in November 2015 by Erin Snyder and her daughter. She is a registered American Quarter Horse (AQHA) mare whose full name is Miss Tee Dee Bar. She is 21 years old now, but Mistee doesn\'t know it. Her forward and smooth gait helps riders at the walk and trot work on their riding skills.  She\'s sensitive to her rider and volunteers and knows just how much patience from her they need. Mistee is looking for a sponsor!  Click above to start HELPing today.'
    },
    {
      image: 'assets/herd/jacktess.jpg',
      name: 'Jack and Tess',
      bio: 'Jack and Tess are the great herd protectors at HELP. As progress closes in around us, coyotes are common visitors at night. Jack and Tess run them out of the field as part of their natural instincts. Jack also thinks of himself as the official welcoming committee. He will let out a very loud bray to welcome you to his home.'
    }
  ]
}
